...
| 名称（中国語） | Voice ID |
|----------------|----------|
| 俏皮女孩（おちゃめな女の子） | `voice-tone-PGLiTXeJCS` |
| 可爱女孩（かわいい女の子） | `voice-tone-PGLiyZt65w` |
| 可爱少女（かわいい少女） | `voice-tone-PGLjbHIMbI` |
| 温柔少女（優しい少女） | `voice-tone-PGLlrd5SNM` |
| 清冷御姐（クールなお姉さん） | `voice-tone-PGLlMvr0Ai` |
| 他5つ... | |
