...
# ARM + CUDA 平台上 ORT_ENABLE_ALL 会触发 Conv1D channels_last 错误
# 对于 codec_encoder 和 speaker_encoder，使用 ORT_DISABLE_ALL 以确保兼容性
_OPT_LEVEL = os.environ.get("QWEN3_TTS_ENCODER_OPT", "disable")
...
class CodecEncoder:
    ...
    def __init__(self, onnx_path: str):
        ...
        sess_opts = _get_session_options()
