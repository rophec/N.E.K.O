...
class RoundCoachEngine:
    ...
    def _table_context_perception(self) -> dict[str, Any]:
        ...
        payload["scan_policy"] = "once_per_hand"
    ...
    def _observe_decision(
        ...
        *,
        ...
        return CoachDecision(
            ...
            priority=5,
            action_required=False,
            # An observe result is the normal steady-state path.  Mark it
            # quiet so diagnostics use their cadence instead of writing a JPEG
            # and rebuilding evidence for every 400 ms capture.
            quiet=True,
            summary=summary,
            detail=detail,
            ...
            perception={
                ...
                "strategy": self._cached_strategy_for_hand(hand_result.hand_tiles),
            },
