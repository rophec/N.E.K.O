...
def load_calibration_profile(path: Path) -> CalibrationProfile:
    ...
    return CalibrationProfile(
        ...
        content_left=int(payload.get("content_left") or 0),
        content_top=int(payload.get("content_top") or 0),
        content_width=int(payload.get("content_width") or 0),
        content_height=int(payload.get("content_height") or 0),
